  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" method="post" id="cinemaAddForm">
          <div class="box-body">
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-info pull-right" id="cinemaAddButton" data-loading-text="添加中...">添加</button>
          </div>
          <!-- /.box-footer -->
        </form>
      </div>
...
<script type="text/javascript">
    $(function () {
        var $cinemaAddForm = $("#cinemaAddForm");
        $cinemaAddForm.submit(function () {
